...
const TechnologyVision = () => {
  return (
    <div className="flex flex-col w-full bg-black h-screen min-h-[640px] pad:min-h-[768px] desktop:min-h-[1080px] text-center text-main-white">
      ...
      <div className="flex flex-col pad:flex-row justify-center items-center h-full gap-y-[clamp(24px,6.667vw,100vw)] pad:gap-y-[0px] pad:gap-x-[clamp(116px,10.741vw,100vw)] desktop:gap-x-[clamp(64px,3.333vw,100vw)] text-[clamp(13px,3.611vw,16px)] pad:text-[clamp(16px,1.481vw,28px)] desktop:text-[clamp(24px,1.25vw,100vw)] leading-[140%] pad:leading-[125%] desktop:leading-[166%] desktop:pb-[clamp(80px,4.167vw,100px)]">
        <div className="flex pad:flex-col-reverse desktop:flex-col pad:justify-between desktop:justify-center items-center pad:items-start w-[clamp(265px,73.611vw,450px)] pad:w-[clamp(203px,18.796vw,396px)] desktop:w-[clamp(396px,20.625vw,100vw)]">
          ...
          <h4 className="mx-auto desktop:mt-[clamp(47px,2.448vw,100vw)] w-[clamp(126px,35vw,170px)] pad:w-[clamp(150px,13.9vw,396px)] desktop:w-[clamp(396px,20.625vw,100vw)] pad:h-[clamp(74px,6.852vw,100vw)] desktop:h-auto ">
            One API works with any OS, device, and browser.
          </h4>
        </div>
        <div className="flex flex-row-reverse pad:flex-col-reverse desktop:flex-col items-center desktop:justify-center pad:items-start w-[clamp(265px,73.611vw,450px)] pad:w-[clamp(203px,18.796vw,396px)] desktop:w-[clamp(396px,20.625vw,100vw)]">
          ...
          <h4 className="mx-auto desktop:mt-[clamp(47px,2.448vw,100vw)] pr-[clamp(0px,3.8vw,35px)] pad:pr-[0px] w-[clamp(115px,31.944vw,170px)] pad:w-[clamp(170px,15.741vw,252px)] desktop:w-[clamp(252px,13.125vw,100vw)] pad:h-[clamp(74px,6.852vw,100vw)] desktop:h-auto">
            Simple and easy integration.
          </h4>
        </div>
        <div className="flex pad:flex-col-reverse desktop:flex-col items-center pad:items-start pad:justify-between desktop:justify-center w-[clamp(265px,73.611vw,450px)] pad:w-[clamp(203px,18.796vw,396px)] desktop:w-[clamp(396px,20.625vw,100vw)]">
          ...
          <h4 className="mx-auto desktop:mt-[clamp(47px,2.448vw,100vw)] w-[clamp(102px,28.34vw,120px)] pad:w-[clamp(120px,11.111vw,256px)] desktop:w-[clamp(256px,13.333vw,100vw)] pad:h-[clamp(74px,6.852vw,100vw)] desktop:h-auto">
