...
const TechnologyVision = () => {
  return (
    <div className="flex flex-col w-full bg-black min-h-screen text-center text-main-white">
      <h3 className="font-semibold font-spline tracking-[.01em] pt-[clamp(60px,16.667vw,105px)] pad:pt-[clamp(105px,9.722vw,160px)] desktop:pt-[clamp(129px,6.719vw,100vw)] pb-[clamp(25px,6.944vw,50px)] pad:pb-[0px] tracking-[.01em] text-[clamp(22px,6.111vw,42px)] pad:text-[clamp(38px,3.519vw,66px)] desktop:text-[clamp(60px,3.125vw,100vw)] leading-[163%] pad:leading-[155%] desktop:leading-[143%]">
        Focus on your product,
        <br />
        and let us handle the rest.
      </h3>
      <div className="flex flex-col pad:flex-row justify-center items-center pad:gap-x-[clamp(75px,6.944vw,100vw)] desktop:gap-x-[clamp(64px,3.333vw,100vw)] text-[clamp(12px,3.333vw,16px)] pad:text-[clamp(14px,1.296vw,28px)] desktop:text-[clamp(24px,1.25vw,100vw)] leading-[150%] pad:leading-[170%] desktop:leading-[166%] pad:pb-[clamp(183px,16.944vw,250px)] desktop:pb-[clamp(80px,4.167vw,100px)] pad:pt-[clamp(60px,5.556vw,140px)] desktop:pt-[clamp(100px,5.208vw,100vw)]">
        <div className="flex pad:flex-col pad:justify-center items-center pad:items-start w-[clamp(235px,65.278vw,450px)] pad:w-[clamp(223px,20.648vw,396px)] desktop:w-[clamp(396px,20.625vw,100vw)] mb-[clamp(24px,6.667vw,40px)] pad:mb-[0px]">
        ...
        <div className="flex flex-row-reverse pad:flex-col items-center pad:justify-center pad:items-start w-[clamp(265px,73.611vw,450px)] pad:w-[clamp(223px,20.648vw,396px)] desktop:w-[clamp(396px,20.625vw,100vw)] mb-[clamp(24px,6.667vw,40px)] pad:mb-[0px]">
        ...
        <div className="flex pad:flex-col items-center pad:items-start pad:justify-center w-[clamp(265px,73.611vw,450px)] pad:w-[clamp(223px,20.648vw,396px)] desktop:w-[clamp(396px,20.625vw,100vw)] mb-[clamp(24px,6.667vw,40px)] pad:mb-[0px]">
          ...
          <h4 className="mx-auto pad:mt-[clamp(35px,0.1vw,47px)] desktop:mt-[clamp(47px,2.448vw,100vw)] w-[clamp(95px,26.389vw,120px)] pad:w-[clamp(175.54px,16.254vw,256px)] desktop:w-[clamp(256px,13.333vw,100vw)] pad:h-[clamp(59.66px,5.524vw,100vw)] desktop:h-auto">
