  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col desktop:justify-center w-[clamp(272px,75.556vw,710px)] pad:w-[clamp(710px,65.741vw,910px)]  desktop:w-[clamp(455px,23.698vw,100vw)]">
        <h3 className="font-bold text-[clamp(14px,3.889vw,26px)] pad:text-[clamp(26px,2.407vw,42px)] desktop:text-[clamp(40px,2.083vw,100vw)] leading-[110%] desktop:leading-[130%] my-[clamp(14.5px,4.028vw,25px)] pad:my-[clamp(25px,2.315vw,100vw)] desktop:my-[clamp(24px,1.25vw,100vw)]">
          {width >= 1920 ? <>{titleList[0]}<br />{titleList.slice(1,4).join(" ")}</> : title}
        </h3>
        <h4 className="text-[clamp(12px,3.333vw,18px)] pad:text-[clamp(18px,1.667vw,23px)] desktop:text-[clamp(20px,1.042vw,100vw)] leading-[130%] pad:leading-[120%] desktop:leading-[150%]">
          {description}
        </h4>
      </div>
    </div>
