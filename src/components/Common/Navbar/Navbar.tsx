...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed flex justify-between items-center w-full mobile:px-19pxr mobile:pt-[clamp(16px,4.444vw,20px)] pad:p-[clamp(20px,1.852vw,34px)] desktop:p-[clamp(34px,1.771vw,36px)] bg-transparent z-[100]">
