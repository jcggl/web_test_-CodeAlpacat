...
const Navbar = () => {
  ...
  return (
    <>
      <nav style={style} className="fixed flex justify-between items-center w-full px-[clamp(19px,5.278vw,30px)] pt-[clamp(16px,4.444vw,20px)] pad:p-[clamp(20px,1.852vw,34px)] desktop:p-[clamp(34px,1.771vw,36px)] bg-transparent z-[100] animate-[navSlideDown_.5s_ease-out] transition ease-in-out duration-[350ms]">
