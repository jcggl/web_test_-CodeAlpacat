    ...
    <>
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`absolute flex items-center justify-end right-0 pr-[1vw] rounded-[5rem] pad:w-[clamp(96px,8.889vw,154px)] desktop:w-[clamp(145px,7.552vw,174px)] aspect-[96/28] transition-all ease-in-out duration-[300ms] ${isHomeBackground} ${isNotHome} ${hoverHire}`}
        >
          <div
            className={`${
              hoverHire === "right-[-2vw]" ? "opacity-100" : "opacity-0"
