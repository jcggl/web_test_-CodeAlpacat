...
const HiringButton = ({animationStyle}:{animationStyle:{transform:string}}) => {
  return (
    <div
      ...
      className="flex justify-center items-center w-[clamp(130px,36.111vw,157px)] pad:w-[clamp(140px,12.963vw,248px)] desktop:w-[clamp(182px,9.479vw,100vw)] h-[clamp(34.67px,9.631vw,46px)] pad:h-[clamp(42px,3.889vw,64px)] desktop:h-[clamp(54px,2.813vw,100vw)] bg-main-white rounded-[5rem] text-[clamp(16px,4.444vw,20px)] pad:text-[clamp(16px,1.481vw,30px)] desktop:text-[clamp(24px,1.25vw,100vw)]"
    >
      <a
