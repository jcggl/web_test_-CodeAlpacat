...
const JoinUs = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden h-[83.704vh]">
      ...
      >
        <h4
          className="font-light text-[clamp(20px,5.556vw,30px)] pad:text-[clamp(30px,2.778px,50px)] desktop:text-[clamp(50px,2.604vw,100vw)]"
        >
          Join Us
        </h4>
        <h3
          style={style}
          className="font-medium text-[clamp(30px,8.333vw,60px)] pad:text-[clamp(60px,5.556vw,90px)] desktop:text-[clamp(90px,4.688vw,100vw)] leading-[140%] pad:leading-[130%] desktop:leading-[120%]"
        >
