...
const SubIntro = () => {
  ...
  return (
    <div className="w-full h-screen font-spline text-main-white">
      {/* title */}
      <div className="flex mobile:flex-col pad:flex-row pad:items-center ml-[clamp(30px,5.041vw,178px)] mobile:pt-[clamp(84px,23.3vw,130px)] pad:pt-[clamp(152px,14.074vw,180px)]">
        <h3
        ...
        <div
          className="mobile:flex pad:block mobile:flex-row-reverse desktop:w-[clamp(359px,18.698vw,400px)] mobile:pt-[clamp(45px,12.5vw,106px)] pad:pt-[clamp(106px,9.815vw,140px)] desktop:pt-[clamp(75px,3.906vw,100px)] mobile:ml-[clamp(178px,55vw,768px)] pad:ml-[clamp(40px,4vw,260px)] desktop:ml-[clamp(30px,30vw,140px)]"
          ref={assetRef}
          style={assetStyle}
        >
          <img
      ...
      <div
        ref={subTitleRef}
        style={subTitleStyle}
        className="flex mobile:flex-row-reverse pad:flex-row-reverse relative mobile:pt-[clamp(10px,2.778vw,50px)] pad:pt-[clamp(75px,6.944vw,90px)] desktop:pt-[clamp(106px,5.521vw,130px)]"
      >
