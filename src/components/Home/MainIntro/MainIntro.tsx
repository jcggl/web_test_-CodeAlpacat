...
import leftWall from "@/assets/home/main-intro/left-wall.png";
import rightWall from "@/assets/home/main-intro/right-wall.png";
import topWall from "@/assets/home/main-intro/top-wall.png";
import bottomWall from "@/assets/home/main-intro/bottom-wall.png";

const MainIntro = () => {
  return (
    <div className="relative w-screen h-screen">
      <h3 className="absolute mobile:top-[clamp(213px,59.167vw,229px)] pad:top-[clamp(229px,21.204vw,295px)] desktop:top-[clamp(295px,15.365vw,350px)] text-main-white font-spline font-semibold mobile:left-[clamp(33px,9.167vw,201px)] pad:left-[clamp(201px,18.611vw,384px)] desktop:left-[clamp(384px,20vw,100vw)] mobile:text-[clamp(40px,11.111vw,95px)] pad:text-[clamp(95px,8.796vw,150px)] desktop:text-[clamp(150px,7.813vw,100vw)] leading-[118%] mobile:animate-[mobileSlideDown_.5s_ease-out] pad:animate-[padSlideDown_.5s_ease-out] desktop:animate-[desktopSlideDown_.5s_ease-out]">
        Inspire Life
        <br />
        Into Avatars
      </h3>
      <h4 className="mobile:hidden pad:block absolute pad:top-[clamp(524px,48.519vw,741px)] desktop:top-[clamp(741px,38.594vw,1000px)] text-main-white pad:right-[clamp(175px,16.204vw,318px)] desktop:right-[clamp(318px,16.563vw,100vw)] pad:text-[clamp(20px,1.852vw,34px)] desktop:text-[clamp(34px,1.771vw,100vw)] pad:leading-[140%] desktop:leading-[130%] mobile:animate-[mobileSlideUp_.5s_ease-out] pad:animate-[padSlideUp_.5s_ease-out] desktop:animate-[desktopSlideUp_.5s_ease-out]">
